# Logic Apps Consumption — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Logic/workflows`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Logic/workflows`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
