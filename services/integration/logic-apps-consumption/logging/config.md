# Logic Apps Consumption — Diagnostic Logging Configuration
...
- Logic Apps Consumption log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-logic-workflows-logs>
