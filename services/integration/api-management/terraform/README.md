...
module "api_management" {
  source = "./services/integration/api-management/terraform"
...
- [ ] Verify `azurerm_api_management` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.ApiManagement/service`.
