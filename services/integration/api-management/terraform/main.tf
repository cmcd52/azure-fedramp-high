...
#
# Deploys API Management with FedRAMP High compliant configuration.
# NIST 800-53 Rev 5: SC-7, SC-8, IA-2, AU-12, CP-9, AC-3
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.ApiManagement/service.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.ApiManagement/service at:
