# API Management — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ApiManagement/service`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ApiManagement/service`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
