# Notification Hubs — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.NotificationHubs/namespaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.NotificationHubs/namespaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
