# Azure Health Data Services — Diagnostic Logging Configuration
...
- Azure Health Data Services log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-healthcareapis-workspaces-logs>
