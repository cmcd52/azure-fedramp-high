# Azure Health Data Services — Terraform Module
...
module "health_data_services" {
  source = "./services/integration/health-data-services/terraform"
...
- [ ] Verify `azurerm_healthcare_workspace` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.HealthcareApis/workspaces`.
