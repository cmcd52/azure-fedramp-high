# Azure Health Data Services — Security Control Baseline
...
- **Azure Policy**: Assign the [`fedramp-high-health-data-services-v1`](../policies/initiatives/fedramp-high-health-data-services-v1.json) initiative at the management-group or subscription scope (NIST CM-2, CM-6).
- **Resource locks**: Apply `CanNotDelete` to production resources (NIST CM-5).
- **Tagging**: Apply `compliance-framework=FedRAMP-High` and `service=health-data-services` tags via the Terraform module's `tags` variable (NIST CM-8).
...
- Azure Health Data Services documentation: <https://learn.microsoft.com/en-us/azure/health-data-services/>
