# Azure Health Data Services — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.HealthcareApis/workspaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.HealthcareApis/workspaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
