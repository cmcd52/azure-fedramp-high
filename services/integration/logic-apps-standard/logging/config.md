# Logic Apps Standard — Diagnostic Logging Configuration
...
- Logic Apps Standard log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-web-sites-logs>
