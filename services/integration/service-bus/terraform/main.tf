...
#
# Deploys Service Bus with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.ServiceBus/namespaces.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.ServiceBus/namespaces at:
