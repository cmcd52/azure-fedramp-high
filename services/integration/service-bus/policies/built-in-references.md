# Service Bus — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ServiceBus/namespaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ServiceBus/namespaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
