# Terraform Module: Event Grid
#
# Deploys Event Grid with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.EventGrid/topics.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.EventGrid/topics at:
