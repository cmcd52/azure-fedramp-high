# Event Grid — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.EventGrid/topics`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.EventGrid/topics`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
