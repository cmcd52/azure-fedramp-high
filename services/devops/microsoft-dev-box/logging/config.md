# Microsoft Dev Box — Diagnostic Logging Configuration
...
- Microsoft Dev Box log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-devcenter-devcenters-logs>
