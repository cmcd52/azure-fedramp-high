# Terraform Module: Microsoft Dev Box
#
# Deploys Microsoft Dev Box with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    name                           = "${var.name}-psc"
    private_connection_resource_id = azurerm_dev_center.this.id
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.DevCenter/devcenters at:
