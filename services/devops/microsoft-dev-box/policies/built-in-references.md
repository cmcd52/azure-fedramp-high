# Microsoft Dev Box — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DevCenter/devcenters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DevCenter/devcenters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
