# Azure Load Testing — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.LoadTestService/loadTests`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.LoadTestService/loadTests`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
