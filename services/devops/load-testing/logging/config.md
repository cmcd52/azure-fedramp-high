# Azure Load Testing — Diagnostic Logging Configuration
...
- Azure Load Testing log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-loadtestservice-loadtests-logs>
