# Azure Chaos Studio — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Chaos/experiments`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Chaos/experiments`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
