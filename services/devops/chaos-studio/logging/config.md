# Azure Chaos Studio — Diagnostic Logging Configuration
...
- Azure Chaos Studio log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-chaos-experiments-logs>
