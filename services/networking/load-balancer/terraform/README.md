...
module "load_balancer" {
  source = "./services/networking/load-balancer/terraform"
...
- [ ] Verify `azurerm_lb` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/loadBalancers`.
