# Azure Load Balancer — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/loadBalancers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/loadBalancers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
