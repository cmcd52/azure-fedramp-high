...
module "traffic_manager" {
  source = "./services/networking/traffic-manager/terraform"
...
- [ ] Verify `azurerm_traffic_manager_profile` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/trafficManagerProfiles`.
