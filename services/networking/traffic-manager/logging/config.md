# Traffic Manager — Diagnostic Logging Configuration
...
- Traffic Manager log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-trafficmanagerprofiles-logs>
