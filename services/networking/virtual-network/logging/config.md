# Virtual Network — Diagnostic Logging Configuration
...
- Virtual Network log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-virtualnetworks-logs>
