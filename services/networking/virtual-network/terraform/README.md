...
module "virtual_network" {
  source = "./services/networking/virtual-network/terraform"
...
- [ ] Verify `azurerm_virtual_network` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/virtualNetworks`.
