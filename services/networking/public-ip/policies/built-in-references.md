# Azure Public IP Address — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/publicIPAddresses`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/publicIPAddresses`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
