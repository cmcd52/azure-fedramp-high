# Azure DDoS Protection — Terraform Module
...
module "ddos_protection" {
  source = "./services/networking/ddos-protection/terraform"
...
- [ ] Verify `azurerm_network_ddos_protection_plan` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/ddosProtectionPlans`.
