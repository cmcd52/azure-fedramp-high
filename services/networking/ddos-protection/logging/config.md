# Azure DDoS Protection — Diagnostic Logging Configuration
...
- Azure DDoS Protection log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-ddosprotectionplans-logs>
