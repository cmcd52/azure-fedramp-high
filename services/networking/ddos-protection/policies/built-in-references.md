# Azure DDoS Protection — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/ddosProtectionPlans`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/ddosProtectionPlans`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
