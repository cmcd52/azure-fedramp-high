# VPN Gateway — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/virtualNetworkGateways`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/virtualNetworkGateways`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
