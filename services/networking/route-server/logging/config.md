# Route Server — Diagnostic Logging Configuration
...
- Route Server log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-virtualhubs-logs>
