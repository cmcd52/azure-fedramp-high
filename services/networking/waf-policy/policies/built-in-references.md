# Web Application Firewall Policy — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
