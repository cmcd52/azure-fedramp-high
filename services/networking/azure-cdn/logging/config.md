# Azure CDN (Microsoft) — Diagnostic Logging Configuration
...
- Azure CDN (Microsoft) log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-cdn-profiles-logs>
