# Azure CDN (Microsoft) — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Cdn/profiles`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Cdn/profiles`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
