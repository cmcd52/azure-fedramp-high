# Azure Firewall — Diagnostic Logging Configuration
...
- Azure Firewall log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-azurefirewalls-logs>
