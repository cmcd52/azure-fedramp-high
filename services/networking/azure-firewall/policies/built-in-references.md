# Azure Firewall — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/azureFirewalls`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/azureFirewalls`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
