...
module "azure_firewall" {
  source = "./services/networking/azure-firewall/terraform"
...
- [ ] Verify `azurerm_firewall` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/azureFirewalls`.
