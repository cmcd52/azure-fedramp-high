# Application Gateway — Diagnostic Logging Configuration
...
- Application Gateway log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-applicationgateways-logs>
