# Application Gateway — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/applicationGateways`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/applicationGateways`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
