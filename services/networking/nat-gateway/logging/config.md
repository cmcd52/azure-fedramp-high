# NAT Gateway — Diagnostic Logging Configuration
...
- NAT Gateway log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-natgateways-logs>
