# Azure Private Link Service — Diagnostic Logging Configuration
...
- Azure Private Link Service log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-privatelinkservices-logs>
