# Azure Private Link Service — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/privateLinkServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/privateLinkServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
