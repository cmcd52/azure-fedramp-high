# Network Watcher — Diagnostic Logging Configuration
...
- Network Watcher log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-networkwatchers-logs>
