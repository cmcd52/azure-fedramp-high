# Network Watcher — Terraform Module
...
module "network_watcher" {
  source = "./services/networking/network-watcher/terraform"
...
This module implements controls in families: **AU, SC**.
See [../controls/baseline.md](../controls/baseline.md) for control-by-control evidence.

## Pending Review Items

- [ ] Verify `azurerm_network_watcher` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/networkWatchers`.
