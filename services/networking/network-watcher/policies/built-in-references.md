# Network Watcher — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/networkWatchers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/networkWatchers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
