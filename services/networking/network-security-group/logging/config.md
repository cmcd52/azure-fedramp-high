# Network Security Group — Diagnostic Logging Configuration
...
- Network Security Group log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-network-networksecuritygroups-logs>
