...
module "network_security_group" {
  source = "./services/networking/network-security-group/terraform"
...
This module implements controls in families: **SC, AC, AU**.
See [../controls/baseline.md](../controls/baseline.md) for control-by-control evidence.

## Pending Review Items

- [ ] Verify `azurerm_network_security_group` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/networkSecurityGroups`.
