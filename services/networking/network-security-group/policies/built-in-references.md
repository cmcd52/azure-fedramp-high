# Network Security Group — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/networkSecurityGroups`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/networkSecurityGroups`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
