# Azure Dedicated Host — Diagnostic Logging Configuration
...
- Azure Dedicated Host log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-compute-hostgroups-logs>
