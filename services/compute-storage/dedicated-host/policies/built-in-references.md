# Azure Dedicated Host — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Compute/hostGroups`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Compute/hostGroups`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
