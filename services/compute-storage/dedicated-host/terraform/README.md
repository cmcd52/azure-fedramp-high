# Azure Dedicated Host — Terraform Module
...
module "dedicated_host" {
  source = "./services/compute-storage/dedicated-host/terraform"
...
This module implements controls in families: **SC, CM**.
See [../controls/baseline.md](../controls/baseline.md) for control-by-control evidence.

## Pending Review Items

- [ ] Verify `azurerm_dedicated_host_group` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Compute/hostGroups`.
