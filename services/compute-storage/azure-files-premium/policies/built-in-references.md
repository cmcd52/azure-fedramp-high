# Azure Files (Premium) — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Storage/storageAccounts/fileServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Storage/storageAccounts/fileServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
