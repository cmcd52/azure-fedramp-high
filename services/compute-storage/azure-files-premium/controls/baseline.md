# Azure Files (Premium) — Security Control Baseline
...
- **Azure Policy**: Assign the [`fedramp-high-azure-files-premium-v1`](../policies/initiatives/fedramp-high-azure-files-premium-v1.json) initiative at the management-group or subscription scope (NIST CM-2, CM-6).
- **Resource locks**: Apply `CanNotDelete` to production resources (NIST CM-5).
- **Tagging**: Apply `compliance-framework=FedRAMP-High` and `service=azure-files-premium` tags via the Terraform module's `tags` variable (NIST CM-8).
...
- Azure Files (Premium) documentation: <https://learn.microsoft.com/en-us/azure/azure-files-premium/>
