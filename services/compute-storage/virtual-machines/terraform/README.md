# Virtual Machines — Terraform Module
...
module "virtual_machines" {
  source = "./services/compute-storage/virtual-machines/terraform"
...
- [ ] Verify `azurerm_linux_virtual_machine` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Compute/virtualMachines`.
