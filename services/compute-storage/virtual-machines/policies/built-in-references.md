# Virtual Machines — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Compute/virtualMachines`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Compute/virtualMachines`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
