# Static Web Apps — Diagnostic Logging Configuration
...
- Static Web Apps log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-web-staticsites-logs>
