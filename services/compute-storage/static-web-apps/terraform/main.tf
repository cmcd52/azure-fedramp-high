# Terraform Module: Static Web Apps
#
# Deploys Static Web Apps with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.Web/staticSites.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.Web/staticSites at:
