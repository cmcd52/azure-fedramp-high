# Azure Service Fabric — Terraform Module
...
module "service_fabric" {
  source = "./services/compute-storage/service-fabric/terraform"
...
- [ ] Verify `azurerm_service_fabric_cluster` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.ServiceFabric/clusters`.
