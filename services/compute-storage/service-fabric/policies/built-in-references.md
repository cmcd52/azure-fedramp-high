# Azure Service Fabric — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ServiceFabric/clusters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ServiceFabric/clusters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
