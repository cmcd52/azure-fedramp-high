# Azure Site Recovery — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.RecoveryServices/vaults`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.RecoveryServices/vaults`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
