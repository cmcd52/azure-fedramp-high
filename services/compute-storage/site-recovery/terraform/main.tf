# Terraform Module: Azure Site Recovery
#
# Deploys Azure Site Recovery with FedRAMP High compliant configuration.
# NIST 800-53 Rev 5: SC-7, SC-13, SC-28, IA-2, AU-12, CP-9
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.RecoveryServices/vaults.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.RecoveryServices/vaults at:
