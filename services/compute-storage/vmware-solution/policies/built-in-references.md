# Azure VMware Solution — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.AVS/privateClouds`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.AVS/privateClouds`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
