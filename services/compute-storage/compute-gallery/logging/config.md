# Azure Compute Gallery — Diagnostic Logging Configuration
...
- Azure Compute Gallery log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-compute-galleries-logs>
