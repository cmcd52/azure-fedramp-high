# Azure Compute Gallery — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Compute/galleries`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Compute/galleries`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
