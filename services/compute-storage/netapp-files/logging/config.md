# Azure NetApp Files — Diagnostic Logging Configuration
...
- Azure NetApp Files log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-netapp-netappaccounts-logs>
