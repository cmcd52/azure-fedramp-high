# Azure NetApp Files — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.NetApp/netAppAccounts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.NetApp/netAppAccounts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
