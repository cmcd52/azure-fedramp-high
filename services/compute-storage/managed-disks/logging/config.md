# Azure Managed Disks — Diagnostic Logging Configuration
...
- Azure Managed Disks log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-compute-disks-logs>
