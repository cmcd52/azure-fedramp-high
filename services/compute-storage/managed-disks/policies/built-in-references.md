# Azure Managed Disks — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Compute/disks`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Compute/disks`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
