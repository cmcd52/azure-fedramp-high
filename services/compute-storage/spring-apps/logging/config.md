# Azure Spring Apps — Diagnostic Logging Configuration
...
- Azure Spring Apps log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-appplatform-spring-logs>
