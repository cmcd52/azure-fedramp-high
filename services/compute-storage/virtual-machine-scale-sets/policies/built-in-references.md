# Virtual Machine Scale Sets — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Compute/virtualMachineScaleSets`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Compute/virtualMachineScaleSets`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
