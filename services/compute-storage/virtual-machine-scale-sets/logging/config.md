# Virtual Machine Scale Sets — Diagnostic Logging Configuration
...
- Virtual Machine Scale Sets log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-compute-virtualmachinescalesets-logs>
