# Azure Email Communication Services — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Communication/emailServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Communication/emailServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
