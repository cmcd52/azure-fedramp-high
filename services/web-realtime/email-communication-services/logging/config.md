# Azure Email Communication Services — Diagnostic Logging Configuration
...
- Azure Email Communication Services log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-communication-emailservices-logs>
