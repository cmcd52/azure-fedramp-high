# Azure Communication Services — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Communication/communicationServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Communication/communicationServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
