# Azure Communication Services — Terraform Module
...
module "communication_services" {
  source = "./services/web-realtime/communication-services/terraform"
...
- [ ] Verify `azurerm_communication_service` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Communication/communicationServices`.
