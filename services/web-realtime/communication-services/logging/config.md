# Azure Communication Services — Diagnostic Logging Configuration
...
- Azure Communication Services log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-communication-communicationservices-logs>
