# Azure SignalR Service — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.SignalRService/signalR`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.SignalRService/signalR`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
