# Azure SignalR Service — Diagnostic Logging Configuration
...
- Azure SignalR Service log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-signalrservice-signalr-logs>
