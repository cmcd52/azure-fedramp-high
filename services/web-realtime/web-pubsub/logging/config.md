# Azure Web PubSub — Diagnostic Logging Configuration
...
- Azure Web PubSub log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-signalrservice-webpubsub-logs>
