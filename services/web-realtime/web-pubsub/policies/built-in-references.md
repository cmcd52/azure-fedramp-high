# Azure Web PubSub — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.SignalRService/webPubSub`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.SignalRService/webPubSub`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
