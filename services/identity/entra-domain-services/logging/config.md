# Microsoft Entra Domain Services — Diagnostic Logging Configuration
...
- Microsoft Entra Domain Services log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-aad-domainservices-logs>
