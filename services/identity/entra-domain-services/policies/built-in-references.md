# Microsoft Entra Domain Services — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.AAD/domainServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.AAD/domainServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
