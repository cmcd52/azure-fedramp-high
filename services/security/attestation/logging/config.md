# Azure Attestation — Diagnostic Logging Configuration
...
- Azure Attestation log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-attestation-attestationproviders-logs>
