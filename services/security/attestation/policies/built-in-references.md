# Azure Attestation — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Attestation/attestationProviders`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Attestation/attestationProviders`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
