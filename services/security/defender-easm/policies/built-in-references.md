# Defender External Attack Surface Management — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Easm/workspaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Easm/workspaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
