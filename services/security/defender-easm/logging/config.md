# Defender External Attack Surface Management — Diagnostic Logging Configuration
...
This service does NOT natively emit diagnostic logs to Log Analytics. Logs are obtained via:

- Azure Activity Log subscription-level diagnostic setting (control-plane operations)
- Microsoft Defender for Cloud security signals
- Service-specific export mechanisms (review service documentation)
...
- Defender External Attack Surface Management log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-easm-workspaces-logs>
