# Azure Bastion Premium — Terraform Module
...
module "bastion_premium" {
  source = "./services/security/bastion-premium/terraform"
...
This module implements controls in families: **AC, AU, IA**.
See [../controls/baseline.md](../controls/baseline.md) for control-by-control evidence.

## Pending Review Items

- [ ] Verify `azurerm_bastion_host` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Network/bastionHosts`.
