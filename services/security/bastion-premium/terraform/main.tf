# Terraform Module: Azure Bastion Premium
#
# Deploys Azure Bastion Premium with FedRAMP High compliant configuration.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.Network/bastionHosts at:
