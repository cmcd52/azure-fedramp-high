# Azure Bastion Premium — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Network/bastionHosts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Network/bastionHosts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
