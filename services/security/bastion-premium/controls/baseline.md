# Azure Bastion Premium — Security Control Baseline



**Service**: Azure Bastion Premium
...
This service primarily addresses control families: **AC, AU, IA**.
...
- **Azure Policy**: Assign the [`fedramp-high-bastion-premium-v1`](../policies/initiatives/fedramp-high-bastion-premium-v1.json) initiative at the management-group or subscription scope (NIST CM-2, CM-6).
- **Resource locks**: Apply `CanNotDelete` to production resources (NIST CM-5).
- **Tagging**: Apply `compliance-framework=FedRAMP-High` and `service=bastion-premium` tags via the Terraform module's `tags` variable (NIST CM-8).
...
- Azure Bastion Premium documentation: <https://learn.microsoft.com/en-us/azure/bastion-premium/>
