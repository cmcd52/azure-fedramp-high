# Azure Key Vault Managed HSM — Diagnostic Logging Configuration
...
- Azure Key Vault Managed HSM log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-keyvault-managedhsms-logs>
