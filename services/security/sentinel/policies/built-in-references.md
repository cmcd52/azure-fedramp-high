# Microsoft Sentinel — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.OperationsManagement/solutions`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.OperationsManagement/solutions`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
