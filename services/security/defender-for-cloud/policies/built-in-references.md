# Microsoft Defender for Cloud — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Security/pricings`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Security/pricings`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
