# Microsoft Defender for Cloud — Diagnostic Logging Configuration
...
- Microsoft Defender for Cloud log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-security-pricings-logs>
