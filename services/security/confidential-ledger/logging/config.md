# Azure Confidential Ledger — Diagnostic Logging Configuration
...
- Azure Confidential Ledger log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-confidentialledger-ledgers-logs>
