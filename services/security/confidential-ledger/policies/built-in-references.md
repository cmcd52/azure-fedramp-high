# Azure Confidential Ledger — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ConfidentialLedger/ledgers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ConfidentialLedger/ledgers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
