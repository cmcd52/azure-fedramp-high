# Azure Migrate — Diagnostic Logging Configuration
...
- Azure Migrate log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-migrate-projects-logs>
