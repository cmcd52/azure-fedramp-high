# Azure Database Migration Service — Diagnostic Logging Configuration
...
- Azure Database Migration Service log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-datamigration-services-logs>
