# Azure Database Migration Service — Terraform Module
...
module "database_migration_service" {
  source = "./services/migration/database-migration-service/terraform"
...
- [ ] Verify `azurerm_database_migration_service` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.DataMigration/services`.
