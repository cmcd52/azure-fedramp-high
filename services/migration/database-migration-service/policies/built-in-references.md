# Azure Database Migration Service — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DataMigration/services`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DataMigration/services`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
