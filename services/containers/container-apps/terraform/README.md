...
module "container_apps" {
  source = "./services/containers/container-apps/terraform"
...
- [ ] Verify `azurerm_container_app` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.App/containerApps`.
