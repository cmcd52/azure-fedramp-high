# Azure Container Apps — Diagnostic Logging Configuration
...
- Azure Container Apps log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-app-containerapps-logs>
