# Azure Container Apps — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.App/containerApps`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.App/containerApps`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
