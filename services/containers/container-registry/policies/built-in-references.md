# Azure Container Registry — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ContainerRegistry/registries`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ContainerRegistry/registries`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
