# Azure Container Registry — Diagnostic Logging Configuration
...
- Azure Container Registry log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-containerregistry-registries-logs>
