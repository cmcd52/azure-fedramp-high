...
module "container_registry" {
  source = "./services/containers/container-registry/terraform"
...
This module implements controls in families: **AC, SC, AU, CM**.
See [../controls/baseline.md](../controls/baseline.md) for control-by-control evidence.

## Pending Review Items

- [ ] Verify `azurerm_container_registry` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.ContainerRegistry/registries`.
