# Azure Kubernetes Service — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ContainerService/managedClusters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ContainerService/managedClusters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
