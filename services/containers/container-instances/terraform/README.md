...
module "container_instances" {
  source = "./services/containers/container-instances/terraform"
...
- [ ] Verify `azurerm_container_group` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.ContainerInstance/containerGroups`.
