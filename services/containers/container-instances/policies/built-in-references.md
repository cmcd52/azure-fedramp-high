# Azure Container Instances — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ContainerInstance/containerGroups`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ContainerInstance/containerGroups`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
