# Azure Container Instances — Diagnostic Logging Configuration
...
- Azure Container Instances log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-containerinstance-containergroups-logs>
