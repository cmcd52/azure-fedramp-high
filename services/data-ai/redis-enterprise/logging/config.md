# Azure Cache for Redis Enterprise — Diagnostic Logging Configuration
...
- Azure Cache for Redis Enterprise log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-cache-redisenterprise-logs>
