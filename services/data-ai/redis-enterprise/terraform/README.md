# Azure Cache for Redis Enterprise — Terraform Module
...
module "redis_enterprise" {
  source = "./services/data-ai/redis-enterprise/terraform"
...
- [ ] Verify `azurerm_redis_enterprise_cluster` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Cache/redisEnterprise`.
