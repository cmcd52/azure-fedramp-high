# Azure Cache for Redis Enterprise — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Cache/redisEnterprise`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Cache/redisEnterprise`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
