...
variable "docintel_account_name" {
  type        = string
  description = "Name of the Azure Document Intelligence (Cognitive Services) account."
  validation {
    condition     = can(regex("^[a-zA-Z][a-zA-Z0-9-]{1,62}[a-zA-Z0-9]$", var.docintel_account_name))
