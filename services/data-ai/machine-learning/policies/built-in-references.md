# Azure Machine Learning — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.MachineLearningServices/workspaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.MachineLearningServices/workspaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
