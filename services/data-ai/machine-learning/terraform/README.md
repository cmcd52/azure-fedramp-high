...
module "machine_learning" {
  source = "./services/data-ai/machine-learning/terraform"
...
- [ ] Verify `azurerm_machine_learning_workspace` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.MachineLearningServices/workspaces`.
