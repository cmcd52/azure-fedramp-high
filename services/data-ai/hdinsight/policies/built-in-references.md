# Azure HDInsight — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.HDInsight/clusters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.HDInsight/clusters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
