...
#
# Deploys Azure Data Factory with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.DataFactory/factories.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.DataFactory/factories at:
