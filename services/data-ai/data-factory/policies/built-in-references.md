# Azure Data Factory — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DataFactory/factories`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DataFactory/factories`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
