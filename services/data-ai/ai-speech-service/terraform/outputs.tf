output "resource_id" {
  description = "The Azure Resource ID of the AI Speech Service account."
  value       = azurerm_cognitive_account.this.id
}

output "resource_name" {
  description = "The name of the AI Speech Service account."
  value       = azurerm_cognitive_account.this.name
}

output "endpoint" {
  description = "The endpoint URL for the AI Speech Service account."
