# Terraform Module: Azure Database for MySQL Flexible Server
#
# Deploys Azure Database for MySQL Flexible Server with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.DBforMySQL/flexibleServers.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.DBforMySQL/flexibleServers at:
