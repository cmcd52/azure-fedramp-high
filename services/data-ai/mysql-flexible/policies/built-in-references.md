# Azure Database for MySQL Flexible Server — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DBforMySQL/flexibleServers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DBforMySQL/flexibleServers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
