# Azure SQL Database — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Sql/servers/databases`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Sql/servers/databases`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
