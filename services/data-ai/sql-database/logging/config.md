# Azure SQL Database — Diagnostic Logging Configuration
...
- Azure SQL Database log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-sql-servers-databases-logs>
