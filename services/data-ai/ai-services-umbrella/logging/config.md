# Azure AI Services (Umbrella) — Diagnostic Logging Configuration
...
- Azure AI Services (Umbrella) log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-cognitiveservices-accounts-logs>
