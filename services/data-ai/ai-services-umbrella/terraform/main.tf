# Terraform Module: Azure AI Services (Umbrella)
#
# Deploys Azure AI Services (Umbrella) with FedRAMP High compliant configuration.
# NIST 800-53 Rev 5: SC-7, SC-13, SC-28, IA-2, AU-12, AC-3
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.CognitiveServices/accounts.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.CognitiveServices/accounts at:
