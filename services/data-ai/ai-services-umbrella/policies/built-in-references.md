# Azure AI Services (Umbrella) — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.CognitiveServices/accounts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.CognitiveServices/accounts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
