# Azure AI Services (Umbrella) — Security Control Baseline



**Service**: Azure AI Services (Umbrella)
...
This service primarily addresses control families: **AC, SC, AU**.
...
- **Azure Policy**: Assign the [`fedramp-high-ai-services-umbrella-v1`](../policies/initiatives/fedramp-high-ai-services-umbrella-v1.json) initiative at the management-group or subscription scope (NIST CM-2, CM-6).
- **Resource locks**: Apply `CanNotDelete` to production resources (NIST CM-5).
- **Tagging**: Apply `compliance-framework=FedRAMP-High` and `service=ai-services-umbrella` tags via the Terraform module's `tags` variable (NIST CM-8).
...
- Azure AI Services (Umbrella) documentation: <https://learn.microsoft.com/en-us/azure/ai-services-umbrella/>
