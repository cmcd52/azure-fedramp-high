# Microsoft Fabric — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Fabric/capacities`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Fabric/capacities`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
