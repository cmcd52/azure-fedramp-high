# Azure Stream Analytics — Diagnostic Logging Configuration
...
- Azure Stream Analytics log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-streamanalytics-streamingjobs-logs>
