# Azure Stream Analytics — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.StreamAnalytics/streamingjobs`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.StreamAnalytics/streamingjobs`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
