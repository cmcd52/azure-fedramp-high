# Azure SQL Server (Logical) — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Sql/servers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Sql/servers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
