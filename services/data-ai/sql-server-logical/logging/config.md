# Azure SQL Server (Logical) — Diagnostic Logging Configuration
...
- Azure SQL Server (Logical) log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-sql-servers-logs>
