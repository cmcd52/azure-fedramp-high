# Azure Analysis Services — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.AnalysisServices/servers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.AnalysisServices/servers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
