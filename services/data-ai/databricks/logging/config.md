# Azure Databricks — Diagnostic Logging Configuration
...
- Azure Databricks log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-databricks-workspaces-logs>
