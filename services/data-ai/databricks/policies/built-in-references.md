# Azure Databricks — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Databricks/workspaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Databricks/workspaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
