# Azure Cache for Redis — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Cache/redis`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Cache/redis`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
