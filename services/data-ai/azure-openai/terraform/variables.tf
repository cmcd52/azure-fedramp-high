...
variable "openai_account_name" {
  ...
  validation {
    condition     = can(regex("^[a-zA-Z][a-zA-Z0-9-]{1,62}[a-zA-Z0-9]$", var.openai_account_name))
...
variable "private_dns_zone_id" {
  type        = string
  description = "Private DNS Zone ID for Private Endpoint DNS registration (privatelink.openai.azure.com)."
  default     = null
  # NIST 800-53: SC-7
}
