...
module "postgresql_flexible" {
  source = "./services/data-ai/postgresql-flexible/terraform"
...
- [ ] Verify `azurerm_postgresql_flexible_server` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.DBforPostgreSQL/flexibleServers`.
