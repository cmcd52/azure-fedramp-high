# Azure Database for PostgreSQL Flexible Server — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DBforPostgreSQL/flexibleServers`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DBforPostgreSQL/flexibleServers`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
