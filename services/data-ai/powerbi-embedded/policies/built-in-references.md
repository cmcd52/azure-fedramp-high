# Power BI Embedded — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.PowerBIDedicated/capacities`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.PowerBIDedicated/capacities`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
