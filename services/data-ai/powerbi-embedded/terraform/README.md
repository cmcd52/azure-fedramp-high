# Power BI Embedded — Terraform Module
...
module "powerbi_embedded" {
  source = "./services/data-ai/powerbi-embedded/terraform"
...
- [ ] Verify `azurerm_powerbi_embedded` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.PowerBIDedicated/capacities`.
