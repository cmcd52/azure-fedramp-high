# Azure SQL Managed Instance — Diagnostic Logging Configuration
...
- Azure SQL Managed Instance log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-sql-managedinstances-logs>
