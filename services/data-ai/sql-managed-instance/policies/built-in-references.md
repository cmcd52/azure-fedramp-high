# Azure SQL Managed Instance — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Sql/managedInstances`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Sql/managedInstances`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
