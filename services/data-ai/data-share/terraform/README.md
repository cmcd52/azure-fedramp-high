# Azure Data Share — Terraform Module
...
```hcl
module "data_share" {
  source = "./services/data-ai/data-share/terraform"
...
- [ ] Verify `azurerm_data_share_account` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.DataShare/accounts`.
