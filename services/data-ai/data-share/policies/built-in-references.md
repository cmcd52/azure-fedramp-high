# Azure Data Share — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DataShare/accounts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DataShare/accounts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
