...
#
# Deploys Azure Cosmos DB with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.DocumentDB/databaseAccounts.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.DocumentDB/databaseAccounts at:
