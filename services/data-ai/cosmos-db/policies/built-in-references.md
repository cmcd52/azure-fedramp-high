# Azure Cosmos DB — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DocumentDB/databaseAccounts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DocumentDB/databaseAccounts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
