# Azure Cosmos DB — Diagnostic Logging Configuration
...
- Azure Cosmos DB log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-documentdb-databaseaccounts-logs>
