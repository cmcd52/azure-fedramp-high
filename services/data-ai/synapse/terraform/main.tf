# Terraform Module: Azure Synapse Analytics
#
# Deploys Azure Synapse Analytics with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.Synapse/workspaces.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.Synapse/workspaces at:
