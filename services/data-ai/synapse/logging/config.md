# Azure Synapse Analytics — Diagnostic Logging Configuration
...
- Azure Synapse Analytics log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-synapse-workspaces-logs>
