# Azure Synapse Analytics — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Synapse/workspaces`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Synapse/workspaces`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
