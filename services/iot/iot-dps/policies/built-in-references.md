# Azure IoT Device Provisioning Service — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Devices/provisioningServices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Devices/provisioningServices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
