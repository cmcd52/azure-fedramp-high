# Terraform Module: Azure IoT Device Provisioning Service
#
# Deploys Azure IoT Device Provisioning Service with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.Devices/provisioningServices.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.Devices/provisioningServices at:
