# Azure IoT Edge — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Devices/IotHubs`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Devices/IotHubs`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
