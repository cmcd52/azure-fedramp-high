# Azure IoT Edge — Diagnostic Logging Configuration
...
- Azure IoT Edge log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-devices-iothubs-logs>
