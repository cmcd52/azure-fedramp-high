# Azure Digital Twins — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DigitalTwins/digitalTwinsInstances`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DigitalTwins/digitalTwinsInstances`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
