# Azure Digital Twins — Terraform Module
...
module "digital_twins" {
  source = "./services/iot/digital-twins/terraform"
...
- [ ] Verify `azurerm_digital_twins_instance` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.DigitalTwins/digitalTwinsInstances`.
