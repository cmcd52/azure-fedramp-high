# Azure IoT Central — Diagnostic Logging Configuration
...
- Azure IoT Central log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-iotcentral-iotapps-logs>
