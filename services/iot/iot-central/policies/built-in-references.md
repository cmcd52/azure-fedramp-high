# Azure IoT Central — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.IoTCentral/IoTApps`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.IoTCentral/IoTApps`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
