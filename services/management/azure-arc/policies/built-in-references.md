# Azure Arc — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.HybridCompute/machines`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.HybridCompute/machines`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
