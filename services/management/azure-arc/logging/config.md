# Azure Arc — Diagnostic Logging Configuration
...
- Azure Arc log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-hybridcompute-machines-logs>
