# Azure Lighthouse — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ManagedServices/registrationDefinitions`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ManagedServices/registrationDefinitions`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
