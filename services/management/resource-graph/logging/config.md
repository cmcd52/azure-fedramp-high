# Azure Resource Graph — Diagnostic Logging Configuration
...
- Azure Resource Graph log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-resourcegraph-queries-logs>
