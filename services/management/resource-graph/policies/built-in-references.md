# Azure Resource Graph — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.ResourceGraph/queries`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.ResourceGraph/queries`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
