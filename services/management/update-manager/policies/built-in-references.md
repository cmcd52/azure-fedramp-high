# Azure Update Manager — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Maintenance/maintenanceConfigurations`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Maintenance/maintenanceConfigurations`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
