# Azure Update Manager — Diagnostic Logging Configuration
...
- Azure Update Manager log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-maintenance-maintenanceconfigurations-logs>
