# Azure Policy — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Authorization/policyDefinitions`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Authorization/policyDefinitions`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
