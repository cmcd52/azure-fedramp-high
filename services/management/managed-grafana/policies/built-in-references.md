# Azure Managed Grafana — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Dashboard/grafana`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Dashboard/grafana`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
