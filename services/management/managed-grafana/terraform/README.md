# Azure Managed Grafana — Terraform Module
...
module "managed_grafana" {
  source = "./services/management/managed-grafana/terraform"
...
- [ ] Verify `azurerm_dashboard_grafana` argument schema against current azurerm provider version.
...
- [X] ~~Replace `subresource_names = ["TODO_SUBRESOURCE_NAME"]`~~ in the Private Endpoint with the correct subresource name for `Microsoft.Dashboard/grafana`.
