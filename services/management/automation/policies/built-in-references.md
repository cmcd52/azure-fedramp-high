# Azure Automation — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Automation/automationAccounts`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Automation/automationAccounts`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
