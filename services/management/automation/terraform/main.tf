# Terraform Module: Azure Automation
#
# Deploys Azure Automation with FedRAMP High compliant configuration.
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    # subresource_names: verify the correct subresource for Microsoft.Automation/automationAccounts.
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  # for Microsoft.Automation/automationAccounts at:
