# Azure Advisor — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.Advisor/recommendations`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.Advisor/recommendations`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
