# Azure Advisor — Security Control Baseline



**Service**: Azure Advisor
**ARM Resource Type**: `Microsoft.Advisor/recommendations`
...
This service primarily addresses control families: **RA, CM**.
...
- **Azure Policy**: Assign the [`fedramp-high-advisor-v1`](../policies/initiatives/fedramp-high-advisor-v1.json) initiative at the management-group or subscription scope (NIST CM-2, CM-6).
- **Resource locks**: Apply `CanNotDelete` to production resources (NIST CM-5).
- **Tagging**: Apply `compliance-framework=FedRAMP-High` and `service=advisor` tags via the Terraform module's `tags` variable (NIST CM-8).
