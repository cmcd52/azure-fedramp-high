# Azure Local (Azure Stack HCI) — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.AzureStackHCI/clusters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.AzureStackHCI/clusters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
