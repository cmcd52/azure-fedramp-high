# Azure Local (Azure Stack HCI) — Diagnostic Logging Configuration
...
- Azure Local (Azure Stack HCI) log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-azurestackhci-clusters-logs>
