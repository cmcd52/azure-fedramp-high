# Azure Operator Nexus — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.NetworkCloud/clusters`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.NetworkCloud/clusters`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
