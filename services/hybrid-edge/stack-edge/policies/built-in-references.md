# Azure Stack Edge — Built-in Azure Policy References
...
|---------------------|------------------------|--------|--------------|
| _Pending review of built-in catalog for `Microsoft.DataBoxEdge/dataBoxEdgeDevices`_ | — | — | — |

## References

- Azure Policy built-in for `Microsoft.DataBoxEdge/dataBoxEdgeDevices`: <https://learn.microsoft.com/en-us/azure/governance/policy/samples/built-in-policies>
