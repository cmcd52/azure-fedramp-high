# Azure Stack Edge — Diagnostic Logging Configuration
...
- Azure Stack Edge log categories: <https://learn.microsoft.com/en-us/azure/azure-monitor/reference/supported-logs/microsoft-databoxedge-databoxedgedevices-logs>
